...
const Chatroom = require("./src/message/models/chatroom.js").Chatroom;

const JWT_SECRET_KEY = process.env.JWT_SECRET_KEY;
// const JWT_SECRET_KEY = "E710E73E4A6A87286F4867761FEE9ED124544B86EB8E0C22E38B90ED27035A95";
const usernames = ["user_driver", "user_rider1", "user_rider2"];
const user_driver = {
...
const users = [user_driver, user_rider1, user_rider2];

const chatroom_demo = {
    driver_username: user_driver.username,
